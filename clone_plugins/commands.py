...
# Subscribe YouTube Channel For Amazing Bot https://t.me/jio_vi_airtel_net
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/jio_vi_airtel_net')
        ],[
...
# Ask Doubt on telegram @rajanxpapa
    ...
    try:
        ...
        title = '@rajanxpapa  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
